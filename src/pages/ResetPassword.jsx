          ...
          <form onSubmit={handleSubmit(createPassword)} className="mt-8">
            <div className="space-y-5">
              <div className="block">
                ...
                {errors.newPassword && (
                  <p className="text-sm dark:text-red-400 text-red-600 font-bold text-left mb-4 mt-2">
              ...
              <Button
                type="submit"
                isLoading={isLoading}
                className="w-full flex justify-center cursor-pointer hover:bg-indigo-700 shadow-md"
              >
                Reset password
              </Button>
            </div>
