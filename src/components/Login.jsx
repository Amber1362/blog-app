  ...
  const login = async (data) => {
    ...
    try {
      ...
      if (session) {
        ...
        if (userData) {
          let profile = await usersService.getUserProfile(userData.$id);
          ...
          <form onSubmit={handleSubmit(login)} className="mt-8">
            <div className="space-y-5">
              <div className="block">
                ...
                />
                {errors.email && (
                  <p className="text-sm dark:text-red-400 text-red-500 text-left mb-4 mt-2">
              ...
              <div className="block">
                ...
                <Link
                  to="/forgot-password"
                  className="font-medium text-indigo-500 dark:text-gray-300 hover:underline text-sm block text-left mt-1"
                >
                  Forgot password?
                </Link>
                {errors.password && (
